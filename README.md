...
Ниже приведена картинка (текст читаемый, нужно просто на картинку нажать, гитхаб в ридми качество немного упрощает) с поднятыми сущностями и ссылками, доступными из интернет на сервисы: приложение, Grafana, Jenkins:     
